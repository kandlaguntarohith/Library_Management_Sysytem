...
public class ShowAllBooksAdmin extends javax.swing.JFrame {

    public JTable returntable() {
        return this.allbooktable;
    }

    public ShowAllBooksAdmin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ShowAllBooksAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ShowAllBooksAdmin().setVisible(true);
            }
        });
    }
