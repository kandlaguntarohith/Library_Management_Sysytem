 ...
 * @author rohit
 */
public class ClientChatWindow1 extends javax.swing.JFrame implements Runnable {
...
//            System.out.println(inputStream.readUTF());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ClientChatWindow1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new ClientChatWindow1().setVisible(true);
            }
        });
//        try {
//            socket = new Socket("localhost", 4000);
